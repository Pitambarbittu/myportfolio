    ...
    <div className='Home'>
        <div className='div__left'>
           ...
           <h1>MY NAME IS</h1> 
            ...
            <h3 style={{color:"orange"}}>Knock of building applications with front and back end operations</h3>
            </section><br /><br />
            <button style={{color:"white"}}> <Link style={{color:"white"}} to='/contact'>Hire Me</Link> </button>

            <button><a style={{color:"white"}} href={bit2} download={bit2}>Download Resume</a></button>
